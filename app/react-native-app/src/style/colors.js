...
export const colors = {
  ...
  transparent: "rgba(0, 0, 0, 0)", // A helper for making something see-thru.
  error: palette.error500, // The default text color in many components.
  errorBackground: palette.error100, // Error background color.
  sucess: palette.error500, // The default text color in many components.
  successBackground: palette.error100, // Success background color.
